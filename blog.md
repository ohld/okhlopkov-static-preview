...
Блог — это не сырой архив Telegram и не вычищенные пересказы. Если материал основан на моём Telegram-посте, живой текст остаётся максимально близко к оригиналу. Сверху добавляются заголовки, дек, TL;DR, FAQ, источники, внутренние ссылки и секция с инсайтами из обсуждений.
